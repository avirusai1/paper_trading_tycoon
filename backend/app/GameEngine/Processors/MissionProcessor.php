...
final class MissionProcessor implements MissionProcessorContract
{
    ...
    private function advanceWithEvent(GameContext $context, MissionProgressType $trigger): array
    {
        ...
        $shimEvent = new class($context->userId(), $trigger) implements GameEvent
        {
            public function __construct(
                private readonly int $uid,
                public readonly MissionProgressType $triggerType,
            ) {}
            ...
            {
                return 'shim_'.$this->triggerType->value;
            }

            public function idempotencyKey(): string
            {
                return 'shim:'.$this->uid.':'.$this->triggerType->value;
            }
        };
    ...
    private function buildEventFor(MissionProgressType $trigger): GameEvent
    {
        return new class($trigger) implements GameEvent
        {
